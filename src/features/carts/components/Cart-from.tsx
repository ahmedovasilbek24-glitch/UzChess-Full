        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-5 items-start">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="flex flex-col gap-1.5">
                            ...
                            <div
                                className="flex border border-[#2A2F36] rounded-xl overflow-hidden focus-within:border-[#3A4050] transition-colors">
                                <span
                                    className="bg-transparent text-white text-sm px-3 py-3 border-r border-[#2A2F36] shrink-0 flex items-center">
                                    +998
                                </span>
                                <input
                                    type="tel"
            ...
            <div className="bg-[#111417] border border-[#1E2328] rounded-2xl overflow-hidden">
                ...
                <div className="mx-4 mb-4 mt-1 bg-[#1A1D21] rounded-xl p-4 flex gap-3 items-start">
                    <div
                        className="w-5 h-5 rounded-full border border-[#3A4050] flex items-center justify-center shrink-0 mt-0.5">
